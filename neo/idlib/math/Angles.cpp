...
//TODO PYBIND11_PLUGIN(idAngles)
namespace angles
{
	PYBIND11_PLUGIN(idAngles) {
		py::module m("idAngles", "description");
		...
		py::class_<idAngles>(m, "idAngles")
			...
			.def("Normalize360", &idAngles::Normalize360, py::return_value_policy::reference)
			.def("Normalize180", &idAngles::Normalize180, py::return_value_policy::reference)
			;
